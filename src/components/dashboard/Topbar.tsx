...
export function Topbar() {
  const { view, mode, setMode, toggleSidebar } = useAppStore()
  ...
  return (
    <header className="h-[52px] border-b border-[#e8e8e8] flex items-center px-[18px] gap-2.5 flex-shrink-0 bg-white z-30">
      ...
      <div className="flex items-center gap-1">
        <div className="flex items-center bg-[#f5f5f5] rounded-full px-3 py-1.5 gap-2 w-[180px]">
        ...
        <button className="w-[30px] h-[30px] flex items-center justify-center rounded-lg border-none bg-transparent cursor-pointer text-[#a8a8a8] hover:bg-[#0d0d0d] hover:text-white transition-all duration-[160ms] relative">
        ...
        <button className="w-[30px] h-[30px] flex items-center justify-center rounded-lg border-none bg-transparent cursor-pointer text-[#a8a8a8] hover:bg-[#0d0d0d] hover:text-white transition-all duration-[160ms]">
