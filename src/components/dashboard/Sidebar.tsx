              ...
              {group.items.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'w-full flex items-center gap-2 pl-4 py-1.5 rounded-lg cursor-pointer text-[13px] font-medium whitespace-nowrap transition-all duration-[160ms] mb-[1px] relative',
                      isActive
