          ...
          <div className="px-2">
            ...
            {chatList.map((chat) => (
              <button
                key={chat.id}
                className={cn(
                  'w-full flex items-start gap-2 px-2 py-2 rounded-lg cursor-pointer transition-all duration-[160ms] mb-[2px] text-left',
                  chat.active
                    ? 'bg-[#0d0d0d] text-white'
                    : 'text-[#525252] hover:bg-[#0d0d0d] hover:text-white',
                )}
              >
                <MessageSquare className={cn('w-4 h-4 mt-0.5 shrink-0', chat.active ? 'text-white' : 'text-[#a8a8a8]')} />
                {sidebarOpen && (
                    ...
                    {group.items.map((item) => {
                      ...
                      return sidebarOpen ? (
                        <button
                          ...
                          className={cn(
                            'w-full flex items-center gap-2 pl-4 py-1.5 rounded-lg cursor-pointer text-[13px] font-medium whitespace-nowrap transition-all duration-[160ms] mb-[1px]',
                            isActive
                              ? 'bg-[#0d0d0d] text-white'
                              : 'text-[#525252] hover:bg-[#0d0d0d] hover:text-white',
                          )}
