...
const paymentStatusConfig = {
  paid: { label: 'Оплачен', className: 'bg-[#dcfce7] text-[#15803d] border-[#bbf7d0]', icon: CheckCircle },
  pending: { label: 'Ожидает', className: 'bg-[#fafafa] text-[#a16207] border-[#e8e8e8]', icon: Clock },
  failed: { label: 'Ошибка', className: 'bg-[#fee2e2] text-[#be123c] border-[#fecaca]', icon: XCircle },
}
