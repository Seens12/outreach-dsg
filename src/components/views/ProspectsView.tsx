...
const statusConfig: Record<ProspectStatus, { label: string; className: string }> = {
  ...
  new: { label: 'Новый', className: 'bg-[#f5f5f5] text-[#a3a3a3]' },
}
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 h-[5px] bg-[#f0f0f0] rounded-full overflow-hidden">
                        <div
                          className={cn(
                            'h-full rounded-full',
                            p.confidence >= 80 ? 'bg-[#171717]' : p.confidence >= 50 ? 'bg-[#737373]' : 'bg-[#a3a3a3]'
                          )}
                      ...
                      <span className={cn(
                        ...
                        p.confidence >= 80 ? 'text-[#171717]' : p.confidence >= 50 ? 'text-[#525252]' : 'text-[#a3a3a3]'
                      )}>
                        {p.confidence}%
                      </span>
                    </div>
